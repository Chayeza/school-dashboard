    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="schooldashboardApp.student.home.createOrEditLabel">Create or edit a Student</h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
          <Col md="8">
            {loading ? (
              ...
              <AvForm model={isNew ? {} : studentEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  <Label id="idNumberLabel" for="idNumber">
                    Id Number
                  </Label>
                  <AvField
                    id="student-idNumber"
                ...
                <AvGroup>
                  <Label id="raceLabel">Race</Label>
                  <AvInput
                    id="student-race"
                    type="select"
                    className="form-control"
                    name="race"
                    value={(!isNew && studentEntity.race) || 'BLACK'}
                  >
                ...
                <AvGroup>
                  <Label id="nationalityLabel" for="nationality">
                    Nationality
                  </Label>
                  <AvField
